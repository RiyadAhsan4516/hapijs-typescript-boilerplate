...
__decorate([
    (0, typeorm_1.ManyToOne)(() => roleEntity_1.Roles, role => role.userProfiles),
    __metadata("design:type", roleEntity_1.Roles)
], UserProfile.prototype, "role", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => userEntity_1.User, (user) => user.user_profile_id),
