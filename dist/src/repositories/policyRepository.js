...
let PolicyRepository = exports.PolicyRepository = class PolicyRepository {
    constructor() {
        this._policyRepo = data_source_1.AppDataSource.getRepository(policyEntity_1.PolicyReadStatus);
    }
    readStatus() {
