...
let UserProfileService = exports.UserProfileService = class UserProfileService {
    constructor() {
        this.repository = typedi_1.Container.get(userProfileRepository_1.UserProfileRepository);
    }
    createUserProfile(inputs) {
        return __awaiter(this, void 0, void 0, function* () {
            if (inputs.profile_photo)
                inputs.profile_photo = yield (0, fileProcessor_1.fileProcessor)(inputs.profile_photo);
