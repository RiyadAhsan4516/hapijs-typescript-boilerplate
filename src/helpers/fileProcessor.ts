...
export async function fileProcessor(uploaded_file: any, allowed_types: string[], file_size: number = 2000000): Promise<string> {
    // CHECK FILE HEADERS
    ...
    const dest: string = `${filepath}${uploaded_file.path.split("tmp")[1]}.${fileType}`
